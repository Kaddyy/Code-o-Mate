...
#fragenkatalog
frage1 = models.fragenkat(fragennr=1, frage='Ist es deine erste Programmiersprache, welche du lernen möchtest?')
frage2 = models.fragenkat(fragennr=2, frage='Ist es dir wichtig im Anschluss auch weitere Sprachen zu lernen?')
frage3 = models.fragenkat(fragennr=3, frage='Willst du mit dieser Programmiersprache in den Arbeitsmarkt einsteigen?')
frage4 = models.fragenkat(fragennr=4, frage='Wie wichtig ist dir dein späteres Gehalt?')
frage5 = models.fragenkat(fragennr=5, frage='Willst du in Trend-Themen wie Big Data, KI-Entwicklung und Machine Learning einsteigen?')
frage6 = models.fragenkat(fragennr=6, frage='Interessierst du dich für das IoT?')
frage7 = models.fragenkat(fragennr=7, frage='Interessierst du dich für IT-Sicherheit?')
frage8 = models.fragenkat(fragennr=8, frage='Möchtest du DB aufsetzen und verwalten?')
frage9 = models.fragenkat(fragennr=9, frage='Willst du Betriebssysteme programmieren?')
frage10 = models.fragenkat(fragennr=10, frage='Möchtest du Linux / Mac / Windows programmieren?')
frage11 = models.fragenkat(fragennr=11, frage='Möchtest du Softwareanwendungen programmieren?')
frage12 = models.fragenkat(fragennr=12, frage='Interessierst du dich an Mikrocontroller und Maschinen?')
frage13 = models.fragenkat(fragennr=13, frage='Hast du Interesse an Wirtschaftsfelder?')
frage14 = models.fragenkat(fragennr=14, frage='Hast du Interesse daran Zahlen und Statistiken auszuwerten?')
frage15 = models.fragenkat(fragennr=15, frage='Möchtest du SAP programmieren?')
frage16 = models.fragenkat(fragennr=16, frage='Hast du Interesse daran Videospiele zu programmieren?')
frage17 = models.fragenkat(fragennr=17, frage='In welcher Engine möchtest du entwickeln?')
frage18 = models.fragenkat(fragennr=18, frage='Hast du Interesse daran Roboter zu programmieren?')
frage19 = models.fragenkat(fragennr=19, frage='Hast du Interesse daran Webseiten zu programmieren?')
frage20 = models.fragenkat(fragennr=20, frage='Möchtest du im Front-End oder im Back-End programmieren')
frage21 = models.fragenkat(fragennr=21, frage='Hast du Interesse daran Apps zu programmieren?')
frage22 = models.fragenkat(fragennr=22, frage='Möchtest du für Android oder IOS programmieren?')
